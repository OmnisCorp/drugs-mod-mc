...
package net.mcreator.druggiesmodmc.world.dimension;
...
import net.mcreator.druggiesmodmc.item.CokeDimensionItem;
...
public class CokeDimensionDimension extends DruggiesmodmcModElements.ModElement {
	@ObjectHolder("druggiesmodmc:coke_dimension_portal")
	public static final CustomPortalBlock portal = null;

	public CokeDimensionDimension(DruggiesmodmcModElements instance) {
		super(instance, 3);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("druggiesmodmc:coke_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("coke_dimension_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("coke_dimension_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("coke_dimension_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new CokeDimensionItem().setRegistryName("coke_dimension"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("coke_dimension_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("druggiesmodmc:coke_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("druggiesmodmc:coke_dimension")));
				} else {
					entity.func_242279_ag();
				...
				for (int l1 = -1; l1 < 2; ++l1) {
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0 ? Blocks.OAK_LEAVES.getDefaultState() : Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.OAK_LEAVES.getDefaultState(), 3);
					}
				}
			}
